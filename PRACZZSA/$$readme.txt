...
Note.  In case you want to put this minidisk on a real z/OS system,
       I've included an XMIT of a DFDSS backup of volume CYL005.
       Member on this pds, is CYL005XM.

       To recover it,
       TSO RECEIVE INDS(this.pds(CBT005XM))

       Then do a DFDSS restore on the resulting DFDSS backup.
